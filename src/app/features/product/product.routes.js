...
router
    ...
    .get('/:id', userIsAdmin, idIsNumber, idExists(ProductsController), async (req, res) => {
        try {
    ...
    .post('/', userIsAdmin, async (req, res) => {
    ...
    .put('/:id', userIsAdmin, idIsNumber, idExists(ProductsController), async (req, res) => {
    ...
    .delete('/:id', userIsAdmin, idIsNumber, idExists(ProductsController), async (req, res) => {
        const id = parseInt(req.params.id)
