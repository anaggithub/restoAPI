...
router
    ...
    .get('/:id', idIsNumber, userIsAdmin, idExists(UserController), async (req, res) => {
        try {
    ...
    .put('/:id', idIsNumber, userIsAdmin, idExists(UserController), async (req, res) => {
    ...
    .delete('/:id', idIsNumber, userIsAdmin, idExists(UserController), async (req, res) => {
